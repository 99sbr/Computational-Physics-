...
for i = 1:n-1
    ...
    u2 = f2(v2(i)+dt*q1) ;
    q2 = g2(x1(i)+dt*u1,x2(i)+dt*w1,x3(i)+dt*s1) ;
    
    w2 = f3(v3(i)+dt*r1) ;
    r2 = g3(x2(i)+dt*w1,x3(i)+dt*s1) ;
    ...
    x2(i+1) = x2(i)+ dt* (u1+u2)/2;
    v2(i+1) = v2(i) + dt * (q1+q2)/2;
    
    x3(i+1) = x3(i)+dt*(w1+w2)/2;
    v3(i+1) = v3(i)+dt*(r1+r2)/2;
end
